    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Tuple3<Long, Long, Float>> hourlyMax = hourlyTips
                ...
                .process(new ProcessAllWindowFunction<Tuple3<Long, Long, Float>, Tuple3<Long, Long, Float>, TimeWindow>() {
                    @Override
                    public void process(Context context, Iterable<Tuple3<Long, Long, Float>> elements, Collector<Tuple3<Long, Long, Float>> out) throws Exception {
                        System.out.println(elements);
                        Tuple3<Long, Long, Float> max = elements.iterator().next();
                        out.collect(max);
                    }
                });
//				.maxBy(2);
